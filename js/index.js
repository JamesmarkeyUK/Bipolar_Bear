...
function _handleIndexJournalNav() {
    ...
    const _WHATS_NEW_HEADLINES = {
      '1.24': 'The medication and sleep-quality steps look cleaner — the spinner now shows just the answers, without the repeated options that used to appear on either side',
